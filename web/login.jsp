<%-- 
    Document   : login
    Created on : 24 Aug, 2022, 12:38:48 AM
    Author     : Asus
--%>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js" ></script>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <div class="container-fluid">
            <form action="code/login_db.jsp" method="post">
       <div class="card" style="min-width:15rem; background-color:rgba(255, 0, 0, 0.4); border: 1px solid black; backface-visibility: tranparent; margin-left:40%; margin-top: 2%;margin-bottom: 2%; margin-right:60%;">
                  <div class="card-body">
      
    
      <h5 class="card-title" style="text-align:center; font-size: 30px;"><i class="bi bi-person-circle" style="font-size: 70px;"></i><br>Log In</h5>
          <label for="exampleFormControlInput1" class="form-label">Email</label>
  <div class="input-group flex-nowrap">
      <span class="input-group-text" id="addon-wrapping" ><i class="bi bi-envelope"></i></span>
  <input type="mail" class="form-control" placeholder="Email" name="userid">
</div>
  ...
  <input type="submit" class="btn btn-outline-dark" value="LogIn" style="margin-top: 2%;margin-left: 35%;">
                  </div>
              </div>
          </form>
        </div>
