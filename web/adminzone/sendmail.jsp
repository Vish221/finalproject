...
<html>
    ...
    out.print("<script>alert('First Login then come');window.location.href='../login.jsp'</script>");
        ...
        <div class="wrapper">
            ...
            <div class="container-fluid">
                <form action="#"   method="post">
       <div class="card" style=" background-image: linear-gradient(to top, #ff0844 0%, #ffb199 100%);border: 1px solid black; content-aligment:center; margin-top: 2%;margin-bottom: 2%;margin-left:15%; margin-right:15%; ">
                  <div class="card-body"> 
      <h5 class="card-title" style="text-align:center; "><i class="bi bi-send-fill" style="font-size:35px;"></i><br>Send Email</h5>
   <div class="input-group flex-nowrap">
  <input type="mail" class="form-control" placeholder="To" name="email">
  ...
  <input type="submit" class="btn btn-outline-dark" value="Send" style="margin-top: 2%;margin-left: 35%;">
                  </div>
              </div>
          </form>
        </div>
